...
if(1)
{
	...
	//deleted by zhangyue on 2014-07-21 for debugging power consumtion start
	ret = si_mhl_tx_initialize(dev_context);//resume by gary
	//deleted by zhangyue on 2014-07-21 for debugging power consumtion end
	up(&dev_context->isr_lock);
